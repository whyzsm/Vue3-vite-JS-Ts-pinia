<template>
  <el-header class="Tiny-header">
    ...
    <el-menu mode="horizontal" class="Tiny_memu">
      <MenuItem v-for="item in headMenuTree"  :key="item.path" :data="item"  @click="handleClickItem"></MenuItem>
    </el-menu>
...
.Tiny-header {
  ...
  .el-menu--horizontal > .el-menu-item.is-active{border-style: none; background:#2861BD ; color: #fff !important; }
  .Tiny_memu{height: 56px; line-height: 56px;  width: 80%; margin: 0px; padding: 0px;}
