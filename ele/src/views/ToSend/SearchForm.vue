<template>
  <SearchFormPro ref="searchForm" :filter="searchParams" :dataSource="searchFormItems" @onSearch="onSearch" @handleClear="handleClear"/>
</template>
...
console.log('scanStore',scanStore.page)
